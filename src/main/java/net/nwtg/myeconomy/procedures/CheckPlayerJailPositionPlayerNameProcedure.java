...
public class CheckPlayerJailPositionPlayerNameProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		myLogic = CheckPlayerJailPositionPlayerNameIsJailedScriptProcedure.execute(arguments);
		if (myLogic) {
			myPosX = CheckPlayerJailPositionPlayerNameXScriptProcedure.execute(arguments);
			myPosY = CheckPlayerJailPositionPlayerNameYScriptProcedure.execute(arguments);
			myPosZ = CheckPlayerJailPositionPlayerNameZScriptProcedure.execute(arguments);
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(Component.literal((Component.translatable("msg.myeconomy.check_player_bank_player_name.msg1").getString() + "" + StringArgumentType.getString(arguments, "playerName") + " "
						+ Component.translatable("msg.myeconomy.check_player_jail_pos_player_name.msg1").getString() + new java.text.DecimalFormat("##.##").format(myPosX)
