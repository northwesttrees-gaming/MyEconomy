...
public class CheckPlayerPreJailPositionPlayerProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		myLogic = CheckPlayerPreJailPositionPlayerIsJailedScriptProcedure.execute(arguments);
		if (myLogic) {
			myPosX = CheckPlayerPreJailPositionPlayerXScriptProcedure.execute(arguments);
			myPosY = CheckPlayerPreJailPositionPlayerYScriptProcedure.execute(arguments);
			myPosZ = CheckPlayerPreJailPositionPlayerZScriptProcedure.execute(arguments);
			if (entity instanceof Player _player && !_player.level.isClientSide())
				...
				}.getEntity()).getDisplayName().getString() + " " + Component.translatable("msg.myeconomy.check_player_pre_jail_pos_player_name.msg1").getString() + new java.text.DecimalFormat("##.##").format(myPosX)
